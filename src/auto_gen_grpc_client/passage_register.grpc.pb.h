...
class RegisterPassageService final {
 public:
  ...
  template <class BaseClass>
  class ExperimentalWithCallbackMethod_MakeTransaction : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    ExperimentalWithCallbackMethod_MakeTransaction() {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::Service::
    #else
  ...
  #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
  typedef ExperimentalWithCallbackMethod_MakeTransaction<Service > CallbackService;
  #endif

  typedef ExperimentalWithCallbackMethod_MakeTransaction<Service > ExperimentalCallbackService;
  template <class BaseClass>
  ...
  template <class BaseClass>
  class ExperimentalWithRawCallbackMethod_MakeTransaction : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    ExperimentalWithRawCallbackMethod_MakeTransaction() {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::Service::
    #else
      ::grpc::Service::experimental().
        ...
        MarkMethodRawCallback(0,
          new ::grpc::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ...
                   ::grpc::experimental::CallbackServerContext*
    #endif
                     context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response) { return this->MakeTransaction(context, request, response); }));
    }
    ~ExperimentalWithRawCallbackMethod_MakeTransaction() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status MakeTransaction(::grpc::ServerContext* /*context*/, const ::axis::transactions::RegisterPassageRequest* /*request*/, ::axis::transactions::RegisterPassageResponse* /*response*/) override {
