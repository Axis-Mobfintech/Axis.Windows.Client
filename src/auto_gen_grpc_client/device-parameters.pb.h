...
#ifndef GOOGLE_PROTOBUF_INCLUDED_device_2dparameters_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_device_2dparameters_2eproto
...
#include "Protos/accepted-bin.pb.h"
#include "Protos/aid-table.pb.h"
// @@protoc_insertion_point(includes)
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_device_2dparameters_2eproto
...
struct TableStruct_device_2dparameters_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_device_2dparameters_2eproto;
namespace axis {
...
class Parameters PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_device_2dparameters_2eproto);
    return ::descriptor_table_device_2dparameters_2eproto.file_level_metadata[kIndexInFileMessages];
  }
 ...
 private:
  ...
  friend struct ::TableStruct_device_2dparameters_2eproto;
};
// -------------------------------------------------------------------
...
class ParametersResponse PROTOBUF_FINAL :
 ...
 public:
  ...
  bool has_aid_table() const;
  private:
  bool _internal_has_aid_table() const;
  public:
  void clear_aid_table();
  const ::axis::transactions::ApplicationIdentifierTable& aid_table() const;
  ::axis::transactions::ApplicationIdentifierTable* release_aid_table();
  ::axis::transactions::ApplicationIdentifierTable* mutable_aid_table();
  void set_allocated_aid_table(::axis::transactions::ApplicationIdentifierTable* aid_table);
  private:
  const ::axis::transactions::ApplicationIdentifierTable& _internal_aid_table() const;
  ::axis::transactions::ApplicationIdentifierTable* _internal_mutable_aid_table();
  public:
  void unsafe_arena_set_allocated_aid_table(
      ::axis::transactions::ApplicationIdentifierTable* aid_table);
  ::axis::transactions::ApplicationIdentifierTable* unsafe_arena_release_aid_table();

  // .axis.transactions.AcceptedBankIdentificationNumber emv_table = 5;
  bool has_emv_table() const;
  private:
  bool _internal_has_emv_table() const;
  public:
  void clear_emv_table();
  const ::axis::transactions::AcceptedBankIdentificationNumber& emv_table() const;
  ::axis::transactions::AcceptedBankIdentificationNumber* release_emv_table();
  ::axis::transactions::AcceptedBankIdentificationNumber* mutable_emv_table();
  void set_allocated_emv_table(::axis::transactions::AcceptedBankIdentificationNumber* emv_table);
  private:
  const ::axis::transactions::AcceptedBankIdentificationNumber& _internal_emv_table() const;
  ::axis::transactions::AcceptedBankIdentificationNumber* _internal_mutable_emv_table();
  public:
  void unsafe_arena_set_allocated_emv_table(
      ::axis::transactions::AcceptedBankIdentificationNumber* emv_table);
  ::axis::transactions::AcceptedBankIdentificationNumber* unsafe_arena_release_emv_table();
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::axis::transactions::ApplicationIdentifierTable* aid_table_;
  ::axis::transactions::AcceptedBankIdentificationNumber* emv_table_;
...
// .axis.transactions.ApplicationIdentifierTable aid_table = 4;
inline bool ParametersResponse::_internal_has_aid_table() const {
  return this != internal_default_instance() && aid_table_ != nullptr;
}
inline bool ParametersResponse::has_aid_table() const {
  return _internal_has_aid_table();
}
inline const ::axis::transactions::ApplicationIdentifierTable& ParametersResponse::_internal_aid_table() const {
  const ::axis::transactions::ApplicationIdentifierTable* p = aid_table_;
  return p != nullptr ? *p : *reinterpret_cast<const ::axis::transactions::ApplicationIdentifierTable*>(
      &::axis::transactions::_ApplicationIdentifierTable_default_instance_);
}
inline const ::axis::transactions::ApplicationIdentifierTable& ParametersResponse::aid_table() const {
  // @@protoc_insertion_point(field_get:axis.transactions.ParametersResponse.aid_table)
  return _internal_aid_table();
}
inline void ParametersResponse::unsafe_arena_set_allocated_aid_table(
    ::axis::transactions::ApplicationIdentifierTable* aid_table) {
  if (GetArena() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(aid_table_);
  }
  aid_table_ = aid_table;
  if (aid_table) {
    
  } else {
    
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:axis.transactions.ParametersResponse.aid_table)
}
inline ::axis::transactions::ApplicationIdentifierTable* ParametersResponse::release_aid_table() {
  
  ::axis::transactions::ApplicationIdentifierTable* temp = aid_table_;
  aid_table_ = nullptr;
  if (GetArena() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
...
inline ::axis::transactions::ApplicationIdentifierTable* ParametersResponse::unsafe_arena_release_aid_table() {
  // @@protoc_insertion_point(field_release:axis.transactions.ParametersResponse.aid_table)
  
  ::axis::transactions::ApplicationIdentifierTable* temp = aid_table_;
  aid_table_ = nullptr;
  return temp;
}
inline ::axis::transactions::ApplicationIdentifierTable* ParametersResponse::_internal_mutable_aid_table() {
  
  if (aid_table_ == nullptr) {
    auto* p = CreateMaybeMessage<::axis::transactions::ApplicationIdentifierTable>(GetArena());
    aid_table_ = p;
  }
  return aid_table_;
}
inline ::axis::transactions::ApplicationIdentifierTable* ParametersResponse::mutable_aid_table() {
  // @@protoc_insertion_point(field_mutable:axis.transactions.ParametersResponse.aid_table)
  return _internal_mutable_aid_table();
}
inline void ParametersResponse::set_allocated_aid_table(::axis::transactions::ApplicationIdentifierTable* aid_table) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(aid_table_);
  }
  if (aid_table) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(aid_table)->GetArena();
    if (message_arena != submessage_arena) {
      aid_table = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, aid_table, submessage_arena);
    }
  ...
  aid_table_ = aid_table;
  // @@protoc_insertion_point(field_set_allocated:axis.transactions.ParametersResponse.aid_table)
}

// .axis.transactions.AcceptedBankIdentificationNumber emv_table = 5;
inline bool ParametersResponse::_internal_has_emv_table() const {
  return this != internal_default_instance() && emv_table_ != nullptr;
}
inline bool ParametersResponse::has_emv_table() const {
  return _internal_has_emv_table();
}
inline const ::axis::transactions::AcceptedBankIdentificationNumber& ParametersResponse::_internal_emv_table() const {
  const ::axis::transactions::AcceptedBankIdentificationNumber* p = emv_table_;
  return p != nullptr ? *p : *reinterpret_cast<const ::axis::transactions::AcceptedBankIdentificationNumber*>(
      &::axis::transactions::_AcceptedBankIdentificationNumber_default_instance_);
}
inline const ::axis::transactions::AcceptedBankIdentificationNumber& ParametersResponse::emv_table() const {
  // @@protoc_insertion_point(field_get:axis.transactions.ParametersResponse.emv_table)
  return _internal_emv_table();
}
inline void ParametersResponse::unsafe_arena_set_allocated_emv_table(
    ::axis::transactions::AcceptedBankIdentificationNumber* emv_table) {
  if (GetArena() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(emv_table_);
  }
  emv_table_ = emv_table;
  if (emv_table) {
    
  } else {
    
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:axis.transactions.ParametersResponse.emv_table)
}
inline ::axis::transactions::AcceptedBankIdentificationNumber* ParametersResponse::release_emv_table() {
  
  ::axis::transactions::AcceptedBankIdentificationNumber* temp = emv_table_;
  emv_table_ = nullptr;
  if (GetArena() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
...
inline ::axis::transactions::AcceptedBankIdentificationNumber* ParametersResponse::unsafe_arena_release_emv_table() {
  // @@protoc_insertion_point(field_release:axis.transactions.ParametersResponse.emv_table)
  
  ::axis::transactions::AcceptedBankIdentificationNumber* temp = emv_table_;
  emv_table_ = nullptr;
  return temp;
}
inline ::axis::transactions::AcceptedBankIdentificationNumber* ParametersResponse::_internal_mutable_emv_table() {
  
  if (emv_table_ == nullptr) {
    auto* p = CreateMaybeMessage<::axis::transactions::AcceptedBankIdentificationNumber>(GetArena());
    emv_table_ = p;
  }
  return emv_table_;
}
inline ::axis::transactions::AcceptedBankIdentificationNumber* ParametersResponse::mutable_emv_table() {
  // @@protoc_insertion_point(field_mutable:axis.transactions.ParametersResponse.emv_table)
  return _internal_mutable_emv_table();
}
inline void ParametersResponse::set_allocated_emv_table(::axis::transactions::AcceptedBankIdentificationNumber* emv_table) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(emv_table_);
  }
  if (emv_table) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(emv_table)->GetArena();
    if (message_arena != submessage_arena) {
      emv_table = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, emv_table, submessage_arena);
    }
  ...
  emv_table_ = emv_table;
  // @@protoc_insertion_point(field_set_allocated:axis.transactions.ParametersResponse.emv_table)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_device_2dparameters_2eproto
