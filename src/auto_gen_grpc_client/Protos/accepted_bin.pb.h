...
class AcceptedBankIdentificationNumber PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_Protos_2faccepted_5fbin_2eproto);
    return ::descriptor_table_Protos_2faccepted_5fbin_2eproto.file_level_metadata[kIndexInFileMessages];
  }
