...
class PrimaryAccountReferenceBlackList final :
 ...
 public:
  ...
  ~PrimaryAccountReferenceBlackList() override;
  explicit constexpr PrimaryAccountReferenceBlackList(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline PrimaryAccountReferenceBlackList* New() const final {
    return new PrimaryAccountReferenceBlackList();
  }
  ...
  void set_payment_account_reference(ArgT0&& arg0, ArgT... args);
  std::string* mutable_payment_account_reference();
  PROTOBUF_MUST_USE_RESULT std::string* release_payment_account_reference();
  ...
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_payment_account_reference(const std::string& value);
...
void PrimaryAccountReferenceBlackList::set_payment_account_reference(ArgT0&& arg0, ArgT... args) {
 
 payment_account_reference_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* PrimaryAccountReferenceBlackList::mutable_payment_account_reference() {
  std::string* _s = _internal_mutable_payment_account_reference();
...
inline void PrimaryAccountReferenceBlackList::_internal_set_payment_account_reference(const std::string& value) {
  ...
  payment_account_reference_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* PrimaryAccountReferenceBlackList::_internal_mutable_payment_account_reference() {
  
  return payment_account_reference_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* PrimaryAccountReferenceBlackList::release_payment_account_reference() {
  ...
  return payment_account_reference_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
