...
class PrimaryAccountReferenceWhiteList PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_Protos_2fpar_5facceptance_5flist_2eproto);
    return ::descriptor_table_Protos_2fpar_5facceptance_5flist_2eproto.file_level_metadata[kIndexInFileMessages];
  }
