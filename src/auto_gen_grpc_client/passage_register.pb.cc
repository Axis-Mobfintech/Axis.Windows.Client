...
static void InitDefaultsscc_info_RegisterPassageResponse_passage_5fregister_2eproto() {
  ...
  {
    void* ptr = &::axis::transactions::_RegisterPassageResponse_default_instance_;
    new (ptr) ::axis::transactions::RegisterPassageResponse();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::axis::transactions::RegisterPassageResponse::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_RegisterPassageResponse_passage_5fregister_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_RegisterPassageResponse_passage_5fregister_2eproto}, {}};
...
static bool dynamic_init_dummy_passage_5fregister_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_passage_5fregister_2eproto)), true);
namespace axis {
namespace transactions {
...
void RegisterPassageResponse::InitAsDefaultInstance() {
}
...
void RegisterPassageResponse::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_RegisterPassageResponse_passage_5fregister_2eproto.base);
  gateway_uid_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  device_suid_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
void RegisterPassageResponse::SharedDtor() {
  GOOGLE_DCHECK(GetArena() == nullptr);
...
const RegisterPassageResponse& RegisterPassageResponse::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_RegisterPassageResponse_passage_5fregister_2eproto.base);
  return *internal_default_instance();
}
...
void RegisterPassageResponse::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:axis.transactions.RegisterPassageResponse)
  GOOGLE_DCHECK_NE(&from, this);
  const RegisterPassageResponse* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<RegisterPassageResponse>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:axis.transactions.RegisterPassageResponse)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:axis.transactions.RegisterPassageResponse)
    MergeFrom(*source);
  }
}
...
void RegisterPassageResponse::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:axis.transactions.RegisterPassageResponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
