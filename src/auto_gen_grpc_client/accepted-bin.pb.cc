...
static void InitDefaultsscc_info_AcceptedBankIdentificationNumber_Protos_2faccepted_2dbin_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_AcceptedBankIdentificationNumber_Protos_2faccepted_2dbin_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_AcceptedBankIdentificationNumber_Protos_2faccepted_2dbin_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_Protos_2faccepted_2dbin_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_Protos_2faccepted_2dbin_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_Protos_2faccepted_2dbin_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_Protos_2faccepted_2dbin_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_Protos_2faccepted_2dbin_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\031Protos/accepted-bin.proto\022\021axis.transa"
  ...
  "3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_Protos_2faccepted_2dbin_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_Protos_2faccepted_2dbin_2eproto_sccs[1] = {
  &scc_info_AcceptedBankIdentificationNumber_Protos_2faccepted_2dbin_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_Protos_2faccepted_2dbin_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_Protos_2faccepted_2dbin_2eproto = {
  false, false, descriptor_table_protodef_Protos_2faccepted_2dbin_2eproto, "Protos/accepted-bin.proto", 321,
  &descriptor_table_Protos_2faccepted_2dbin_2eproto_once, descriptor_table_Protos_2faccepted_2dbin_2eproto_sccs, descriptor_table_Protos_2faccepted_2dbin_2eproto_deps, 1, 0,
  schemas, file_default_instances, TableStruct_Protos_2faccepted_2dbin_2eproto::offsets,
  file_level_metadata_Protos_2faccepted_2dbin_2eproto, 1, file_level_enum_descriptors_Protos_2faccepted_2dbin_2eproto, file_level_service_descriptors_Protos_2faccepted_2dbin_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_Protos_2faccepted_2dbin_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_Protos_2faccepted_2dbin_2eproto)), true);
namespace axis {
namespace transactions {
...
const AcceptedBankIdentificationNumber& AcceptedBankIdentificationNumber::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_AcceptedBankIdentificationNumber_Protos_2faccepted_2dbin_2eproto.base);
