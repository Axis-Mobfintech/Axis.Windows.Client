...
#ifndef GOOGLE_PROTOBUF_INCLUDED_restriction_5flist_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_restriction_5flist_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_restriction_5flist_2eproto
...
struct TableStruct_restriction_5flist_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_restriction_5flist_2eproto;
namespace axis {
namespace transactions {
class RestrictionListCardInformation;
struct RestrictionListCardInformationDefaultTypeInternal;
extern RestrictionListCardInformationDefaultTypeInternal _RestrictionListCardInformation_default_instance_;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::axis::transactions::RestrictionListCardInformation* Arena::CreateMaybeMessage<::axis::transactions::RestrictionListCardInformation>(Arena*);
...
class RestrictionListRequest final :
 ...
 public:
  ...
  ~RestrictionListRequest() override;
  explicit constexpr RestrictionListRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline RestrictionListRequest* New() const final {
    return new RestrictionListRequest();
  }
 ...
 private:
  ...
  friend struct ::TableStruct_restriction_5flist_2eproto;
};
// -------------------------------------------------------------------

class RestrictionListResponse final :
 ...
 public:
  ...
  ~RestrictionListResponse() override;
  explicit constexpr RestrictionListResponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class RestrictionListCardInformation final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:axis.transactions.RestrictionListCardInformation) */ {
 public:
  inline RestrictionListCardInformation() : RestrictionListCardInformation(nullptr) {}
  ~RestrictionListCardInformation() override;
  explicit constexpr RestrictionListCardInformation(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  RestrictionListCardInformation(const RestrictionListCardInformation& from);
  RestrictionListCardInformation(RestrictionListCardInformation&& from) noexcept
    : RestrictionListCardInformation() {
    *this = ::std::move(from);
  }

  inline RestrictionListCardInformation& operator=(const RestrictionListCardInformation& from) {
    CopyFrom(from);
    return *this;
  }
  inline RestrictionListCardInformation& operator=(RestrictionListCardInformation&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const RestrictionListCardInformation& default_instance() {
    return *internal_default_instance();
  }
  static inline const RestrictionListCardInformation* internal_default_instance() {
    return reinterpret_cast<const RestrictionListCardInformation*>(
               &_RestrictionListCardInformation_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    2;

  friend void swap(RestrictionListCardInformation& a, RestrictionListCardInformation& b) {
    a.Swap(&b);
  }
  inline void Swap(RestrictionListCardInformation* other) {
    if (other == this) return;
    if (GetOwningArena() == other->GetOwningArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(RestrictionListCardInformation* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  inline RestrictionListCardInformation* New() const final {
    return new RestrictionListCardInformation();
  }

  RestrictionListCardInformation* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<RestrictionListCardInformation>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const RestrictionListCardInformation& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom(const RestrictionListCardInformation& from);
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to, const ::PROTOBUF_NAMESPACE_ID::Message& from);
  public:
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(RestrictionListCardInformation* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "axis.transactions.RestrictionListCardInformation";
  }
  protected:
  explicit RestrictionListCardInformation(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  ...
  PROTOBUF_MUST_USE_RESULT ::axis::transactions::PrimaryAccountNumberBlackList* release_pan_list();
  ...
  PROTOBUF_MUST_USE_RESULT ::axis::transactions::PrimaryAccountReferenceBlackList* release_par_list();
...
void RestrictionListRequest::set_device_id(ArgT0&& arg0, ArgT... args) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void RestrictionListRequest::set_operator_id(ArgT0&& arg0, ArgT... args) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void RestrictionListRequest::set_reader_serial_number(ArgT0&& arg0, ArgT... args) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void RestrictionListRequest::set_device_serial_number(ArgT0&& arg0, ArgT... args) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void RestrictionListRequest::set_ksn_data(ArgT0&& arg0, ArgT... args) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void RestrictionListRequest::set_line_id(ArgT0&& arg0, ArgT... args) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void RestrictionListRequest::set_vehicle_id(ArgT0&& arg0, ArgT... args) {
...
// .axis.transactions.PrimaryAccountNumberBlackList pan_list = 1;
inline bool RestrictionListCardInformation::_internal_has_pan_list() const {
  return this != internal_default_instance() && pan_list_ != nullptr;
}
inline bool RestrictionListCardInformation::has_pan_list() const {
  return _internal_has_pan_list();
}
inline const ::axis::transactions::PrimaryAccountNumberBlackList& RestrictionListCardInformation::_internal_pan_list() const {
...
inline const ::axis::transactions::PrimaryAccountNumberBlackList& RestrictionListCardInformation::pan_list() const {
  // @@protoc_insertion_point(field_get:axis.transactions.RestrictionListCardInformation.pan_list)
  return _internal_pan_list();
}
inline void RestrictionListCardInformation::unsafe_arena_set_allocated_pan_list(
    ::axis::transactions::PrimaryAccountNumberBlackList* pan_list) {
  if (GetArenaForAllocation() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:axis.transactions.RestrictionListCardInformation.pan_list)
}
inline ::axis::transactions::PrimaryAccountNumberBlackList* RestrictionListCardInformation::release_pan_list() {
...
inline ::axis::transactions::PrimaryAccountNumberBlackList* RestrictionListCardInformation::unsafe_arena_release_pan_list() {
  // @@protoc_insertion_point(field_release:axis.transactions.RestrictionListCardInformation.pan_list)
  
  ::axis::transactions::PrimaryAccountNumberBlackList* temp = pan_list_;
  pan_list_ = nullptr;
  return temp;
}
inline ::axis::transactions::PrimaryAccountNumberBlackList* RestrictionListCardInformation::_internal_mutable_pan_list() {
  
  if (pan_list_ == nullptr) {
    auto* p = CreateMaybeMessage<::axis::transactions::PrimaryAccountNumberBlackList>(GetArenaForAllocation());
    pan_list_ = p;
  }
  return pan_list_;
}
inline ::axis::transactions::PrimaryAccountNumberBlackList* RestrictionListCardInformation::mutable_pan_list() {
  ::axis::transactions::PrimaryAccountNumberBlackList* _msg = _internal_mutable_pan_list();
  // @@protoc_insertion_point(field_mutable:axis.transactions.RestrictionListCardInformation.pan_list)
  return _msg;
}
inline void RestrictionListCardInformation::set_allocated_pan_list(::axis::transactions::PrimaryAccountNumberBlackList* pan_list) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(pan_list_);
  }
  ...
  pan_list_ = pan_list;
  // @@protoc_insertion_point(field_set_allocated:axis.transactions.RestrictionListCardInformation.pan_list)
}

// .axis.transactions.PrimaryAccountReferenceBlackList par_list = 2;
inline bool RestrictionListCardInformation::_internal_has_par_list() const {
  return this != internal_default_instance() && par_list_ != nullptr;
}
inline bool RestrictionListCardInformation::has_par_list() const {
  return _internal_has_par_list();
}
inline const ::axis::transactions::PrimaryAccountReferenceBlackList& RestrictionListCardInformation::_internal_par_list() const {
...
inline const ::axis::transactions::PrimaryAccountReferenceBlackList& RestrictionListCardInformation::par_list() const {
  // @@protoc_insertion_point(field_get:axis.transactions.RestrictionListCardInformation.par_list)
  return _internal_par_list();
}
inline void RestrictionListCardInformation::unsafe_arena_set_allocated_par_list(
    ::axis::transactions::PrimaryAccountReferenceBlackList* par_list) {
  if (GetArenaForAllocation() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:axis.transactions.RestrictionListCardInformation.par_list)
}
inline ::axis::transactions::PrimaryAccountReferenceBlackList* RestrictionListCardInformation::release_par_list() {
...
inline ::axis::transactions::PrimaryAccountReferenceBlackList* RestrictionListCardInformation::unsafe_arena_release_par_list() {
  // @@protoc_insertion_point(field_release:axis.transactions.RestrictionListCardInformation.par_list)
  
  ::axis::transactions::PrimaryAccountReferenceBlackList* temp = par_list_;
  par_list_ = nullptr;
  return temp;
}
inline ::axis::transactions::PrimaryAccountReferenceBlackList* RestrictionListCardInformation::_internal_mutable_par_list() {
  
  if (par_list_ == nullptr) {
    auto* p = CreateMaybeMessage<::axis::transactions::PrimaryAccountReferenceBlackList>(GetArenaForAllocation());
    par_list_ = p;
  }
  return par_list_;
}
inline ::axis::transactions::PrimaryAccountReferenceBlackList* RestrictionListCardInformation::mutable_par_list() {
  ::axis::transactions::PrimaryAccountReferenceBlackList* _msg = _internal_mutable_par_list();
  // @@protoc_insertion_point(field_mutable:axis.transactions.RestrictionListCardInformation.par_list)
  return _msg;
}
inline void RestrictionListCardInformation::set_allocated_par_list(::axis::transactions::PrimaryAccountReferenceBlackList* par_list) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(par_list_);
  }
  ...
  par_list_ = par_list;
  // @@protoc_insertion_point(field_set_allocated:axis.transactions.RestrictionListCardInformation.par_list)
}

// .axis.transactions.CardAction action = 3;
inline void RestrictionListCardInformation::clear_action() {
  action_ = 0;
}
inline ::axis::transactions::CardAction RestrictionListCardInformation::_internal_action() const {
  return static_cast< ::axis::transactions::CardAction >(action_);
}
inline ::axis::transactions::CardAction RestrictionListCardInformation::action() const {
  // @@protoc_insertion_point(field_get:axis.transactions.RestrictionListCardInformation.action)
  return _internal_action();
}
inline void RestrictionListCardInformation::_internal_set_action(::axis::transactions::CardAction value) {
  
  action_ = value;
}
inline void RestrictionListCardInformation::set_action(::axis::transactions::CardAction value) {
  _internal_set_action(value);
  // @@protoc_insertion_point(field_set:axis.transactions.RestrictionListCardInformation.action)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_restriction_5flist_2eproto
